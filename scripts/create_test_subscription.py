...
async def main() -> None:
    ...
    print(
        ...
        "  payments', and 5104 0155 5555 5558 is an international card, which\n"
        "  this account blocks. Razorpay documents 4718 6091 0820 4366 for\n"
        "  subscriptions; or switch to UPI (success@razorpay) or EMandate in\n"
