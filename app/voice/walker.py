...
class GraphWalker:
    ...
    def stage_instructions(self, *, override_prompt: str | None = None) -> str:
        ...
        return (
            ...
            "Using another tool is not a substitute. Sending a link is an "
            "action; the transition is what records what the customer decided, "
            "and nothing else does it for you.\n\n"
